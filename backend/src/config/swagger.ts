      ...
      schemas: {
        ...
        ReadingQuestionStudent: {
          ...
          properties: {
            ...
            paragraphs: {
              type: 'array',
              description: 'reorder_paragraphs only — shuffled out of correct order. Labels are omitted to prevent students from inferring the correct sequence.',
              items: { type: 'object', properties: { text: { type: 'string', example: 'Finally, the water flows back to the ocean, completing the cycle.' } } },
            },
          },
        },
            ...
            content: {
              'application/json': {
                ...
                examples: {
                  ...
                  mcqMultiple: { summary: 'MCQ multiple', value: { type: 'mcq_multiple', passage: 'Photosynthesis converts light energy into chemical energy stored as glucose. The process takes place in the chloroplasts and releases oxygen as a by-product.', question: 'Which of the following statements about photosynthesis are correct?', options: [{ label: 'A', text: 'Photosynthesis converts light energy into chemical energy.', isCorrect: true }, { label: 'B', text: 'The process occurs in the mitochondria.', isCorrect: false }, { label: 'C', text: 'Oxygen is released as a by-product.', isCorrect: true }, { label: 'D', text: 'Only bacteria can perform photosynthesis.', isCorrect: false }] } },
                  rwFill: { summary: 'R&W fill blanks', value: { type: 'rw_fill_blanks', passage: 'The [1] of climate change is a [2] concern for scientists worldwide.', wordPool: ['impact', 'affect', 'serious', 'minor'], blanks: [{ position: 1, correctAnswer: 'impact', options: ['impact', 'affect'] }, { position: 2, correctAnswer: 'serious', options: ['serious', 'minor'] }] } },
                  readingFill: { summary: 'Reading fill blanks', value: { type: 'reading_fill_blanks', passage: 'The Industrial Revolution [1] the way goods were produced. Factories [2] cottage industries, and oxygen was released as a by-product.', blanks: [{ position: 1, correctAnswer: 'transformed', options: ['transformed', 'ignored', 'delayed'] }, { position: 2, correctAnswer: 'replaced', options: ['replaced', 'duplicated', 'celebrated'] }] } },
                  reorder: { summary: 'Reorder paragraphs', value: { type: 'reorder_paragraphs', passage: 'Arrange the paragraphs about the water cycle in the correct order.', paragraphs: [{ label: 'A', text: 'Water vapour condenses in the upper atmosphere to form clouds.' }, { label: 'B', text: 'Water falls back to Earth as precipitation when droplets accumulate.' }, { label: 'C', text: 'Heat from the sun causes water to evaporate from oceans and rivers.' }, { label: 'D', text: 'Water flows back to the ocean or soaks into the soil, completing the cycle.' }] } },
                },
              },
            },
          },
            ...
            content: {
              'application/json': {
                ...
                examples: {
                  ...
                  rwFillBlanks: { summary: 'R&W fill blanks', value: { questionId: '64f1a2b3c4d5e6f7a8b9c0d1', questionType: 'rw_fill_blanks', answers: ['impact', 'serious'] } },
                  readingFillBlanks: { summary: 'Reading fill blanks', value: { questionId: '64f1a2b3c4d5e6f7a8b9c0d1', questionType: 'reading_fill_blanks', answers: ['transformed', 'replaced'] } },
                  reorder: { summary: 'Reorder paragraphs', value: { questionId: '64f1a2b3c4d5e6f7a8b9c0d1', questionType: 'reorder_paragraphs', answers: ['Heat from the sun causes water to evaporate from oceans and rivers.', 'Water vapour condenses in the upper atmosphere to form clouds.', 'Water falls back to Earth as precipitation when droplets accumulate.', 'Water flows back to the ocean or soaks into the soil, completing the cycle.'] } },
                },
              },
            },
          },
