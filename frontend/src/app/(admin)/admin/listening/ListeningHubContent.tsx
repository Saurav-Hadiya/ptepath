      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {LISTENING_TYPES.map((config) => (
          <Link
            ...
            className="group flex flex-col gap-2 rounded-card border border-border-default border-t-[3px] border-t-module-listening bg-bg-card p-4 shadow-card transition-all duration-200 hover:-translate-y-0.5 hover:shadow-hover sm:p-5"
          >
            <Headphones className="size-6 text-text-primary sm:size-7" strokeWidth={1.75} />
