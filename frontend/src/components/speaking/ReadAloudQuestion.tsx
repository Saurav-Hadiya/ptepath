...
export default function ReadAloudQuestion({ question, onScoreReceived }: Props) {
  const {
    phase,
    submitError,
    micError,
    ...
    onSubmit: (blob) => speakingService.evaluateReadAloud(question.id, blob),
  });
  ...
  return (
    <div className="space-y-5">
      <QuestionTypeBadge type="read_aloud" module="speaking" />

      <p className="text-body-md text-text-secondary">
        Read the passage below aloud. Recording starts after preparation time.
      </p>
