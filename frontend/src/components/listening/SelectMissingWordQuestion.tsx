...
export default function SelectMissingWordQuestion({ question, onScoreReceived }: Props) {
  ...
  const handleSubmit = () => {
    ...
    mutation.mutate(
      { questionId: question.id, questionType: 'select_missing', answer: selectedLabel },
      {
        onSuccess: (result) => {
  ...
  return (
    <div className="space-y-5">
      <p className="text-body-md text-text-secondary">
        The audio ends with a beep. Select the word or phrase that correctly completes what was being said.
      </p>
