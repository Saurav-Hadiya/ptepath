    ...
    <section className="bg-bg-page py-14">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-3xl bg-brand-primary px-6 py-16 text-center sm:px-12 sm:py-20">
          ...
          <span className="text-label-sm text-white/55">
            Join students who improved their score
          </span>

          <div className="relative">
            <h2 className="mb-4 font-display text-display-md font-bold text-white">
              Ready to start your PTE preparation?
            </h2>
            <p className="mx-auto mb-8 max-w-lg text-body-lg text-white/60">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-xl bg-action-default px-10 py-3.5 text-label-lg text-white shadow-button transition-all hover:bg-action-hover hover:shadow-lg"
            >
              Sign In to Practice
              <ArrowRight className="h-4 w-4" />
            </Link>
            <p className="mt-5 text-body-sm text-white/35">
